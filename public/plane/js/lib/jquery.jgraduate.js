    ...
    return this.each(function () {
      ...
      gradPicker.html(
        '<div id="' +
          ...
          '<label class="jGraduate_Form_Heading">开始点</label>' +
          ...
          id +
          '_jGraduate_match_ctr"/>居中对齐</label><br/>' +
          "<label>x:</label>" +
          '<input type="text" id="' +
          id +
          ...
          id +
          '_jGraduate_Ok" class="jGraduate_Ok" value="确认"/>' +
          '<input type="button" id="' +
          id +
          '_jGraduate_Cancel" class="jGraduate_Cancel" value="取消"/>' +
          "</div>"
      );

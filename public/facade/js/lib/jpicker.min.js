  ...
  $.fn.jPicker.defaults =
    /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
    {
      ...
      localization: {
        ...
        tooltips: {
          colors: {
            newColor: "新颜色 - 按“确定”应用",
            currentColor: "点击恢复为原始颜色",
          },
          buttons: {
            ok: "确认选择此颜色",
            cancel: "取消并恢复原始颜色",
          ...
          hue: {
            radio: "设置为“色相”模式",
            textbox: "输入“色相”值（0-360°）",
          },
          saturation: {
            radio: "设置为“饱和度”模式",
            textbox: "输入“饱和度”值（0-100%）",
          },
          value: {
            radio: "设置为“明度”模式",
            textbox: "输入“明度”值（0-100%）",
          },
          red: {
            radio: "设置为“红色”模式",
            textbox: "输入“红色”值（0-255）",
          },
          green: {
            radio: "设置为“绿色”模式",
            textbox: "输入“绿色”值（0-255）",
          },
          blue: {
            radio: "设置为“蓝色”模式",
            textbox: "输入“蓝色”值（0-255）",
          },
          alpha: {
            radio: "设置为“透明度”模式",
            textbox: "输入“透明度”值（0-100）",
          },
          hex: {
            textbox: "输入十六进制颜色值（#000000-#ffffff）",
            alpha: "输入透明度值（#00-#ff）",
          },
        },
      },
